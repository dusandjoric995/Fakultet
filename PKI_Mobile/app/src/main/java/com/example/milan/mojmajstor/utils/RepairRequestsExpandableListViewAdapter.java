...
public class RepairRequestsExpandableListViewAdapter extends BaseExpandableListAdapter {
    ...
    private RepairRequestsExpandableListViewAdapter thisAdapter;

    public RepairRequestsExpandableListViewAdapter(Activity thisActivity, ExpandableListView evRepairRequests, ArrayList<RepairRequest> repairRequests, ArrayList<Integer> checkedReequests, ImageButton btAddidionalOptions) {
    ...
    public View getGroupView(final int groupPosition, boolean isExpanded, View convertView, ViewGroup parent) {
        ...
        if(convertView == null){
            ...
            convertView = inflater.inflate(R.layout.list_view_group_item_repair_request, null);
        }
    ...
    public View getChildView(int groupPosition, final int childPosition, boolean isLastChild, View convertView, ViewGroup parent) {
        ...
        if(convertView == null){
            LayoutInflater inflater = (LayoutInflater) thisActivity.getSystemService(Context.LAYOUT_INFLATER_SERVICE);
            convertView = inflater.inflate(R.layout.list_view_child_item_repair_request, null);
        }
